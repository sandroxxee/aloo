...
const NAV_ITEMS = [
  ...
  { id: 'leads', label: 'Vault', icon: Database },
  { id: 'crm_kanban', label: 'Pipeline', icon: Sliders },
  { id: 'maps', label: 'Radar', icon: Globe },
  { id: 'keywords', label: 'Intel', icon: Brain },
  { id: 'whatsapp', label: 'Relay', icon: Smartphone },
];
...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="h-16 bg-white/95 dark:bg-slate-950/95 backdrop-blur-3xl border-b border-slate-100 dark:border-slate-900 sticky top-0 z-50 transition-all duration-500 shadow-sm">
      <div className="max-w-[1920px] mx-auto h-full px-6 flex items-center justify-between gap-8">
        ...
        <div className="flex items-center gap-3 shrink-0">
          ...
          >
            ...
            <span className="hidden xl:inline">{currentUser ? 'Cloud Active' : 'Sync Gateway'}</span>
          </button>
